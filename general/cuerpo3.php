                        ...
                        <div class="testimonials">
                            <div id="testimonials">
                                <ul>
                                    <li>
                                        <div>
                                            “La programacion a traves de SogaApp nos dismunuye el trabajo de una gran manera.”
                                        </div>
                                        <span><strong class="color1">Pablo Aranzazu</strong> <br>
                                            Analista de sistemas</span>
                                    </li>
                                    <li>
                                        <div>
                            ...
                            <table class="col1">
                                <tr class="color1">
                                   ...
                                   <tr>
                                     ...
                                     <td>Las programaciones de pago no pueden ser pagadas si uno de sus pagos tiene el valor neto menor que cero</td>
                                   </tr>
                                   <tr>
                                     <td>Correccion</td>
                                     <td>2016-11-24</td>
                                     <td>Recurso Humano</td>
                                     <td>Cuando se liquida una programacion de pago se actualizan los valores netos del detalle y el numero de pagos que contiene</td>
                                   </tr>
                                   <tr>
                                     <td>Nueva herramienta</td>
                                     <td>2016-11-24</td>
                                     <td>Recurso Humano</td>
                                     <td>Registro de reclamaciones de los empleados para casos de nomina</td>
                                   </tr>
                                   <tr>
                                     <td>Nueva herramienta</td>
                                     <td>2016-11-24</td>
                                     <td>Inventario</td>
                                     <td>Avanza el modulo de inventario</td>
                                   </tr>
                                   <tr>
                                     <td>Cambio Menu</td>
                                     <td>2016-11-24</td>
                                     <td>Recurso HUmano</td>
                                     <td>El acceso a la aplicacion de creditos cambio: Movimiento -> Recurso humano -> Nomina -> Creditos</td>
                                   </tr>                                   
                               </table>
                        </div>
                    </section>
